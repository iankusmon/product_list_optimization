...
# product-lists-api is the backend (Python/Flask app)
...
# product-lists-web is the frontend (ReactJS/vite app)
...
docker_build(
    ...
    live_update=[
        ...
        run(
            'yarn install',
            'npm i /app/npm_requirements.txt',
...
if config.tilt_subcommand == 'up':
    print("""
    \033[32m\033[32mHello World from the Docker + Tilt product-lists sample app!\033[0m
